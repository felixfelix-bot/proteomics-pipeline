...
\centering
\includegraphics[width=0.95\linewidth]{figures/volcano_turbo.pdf}
\end{block}

\begin{block}{Results 2: GO Enrichment (Biological Process)}
\centering
\includegraphics[width=0.95\linewidth]{figures/go_bp_turbo.pdf}
\end{block}

\begin{block}{Results 3: KEGG Pathways}
\centering
\includegraphics[width=0.95\linewidth]{figures/kegg_turbo.pdf}
\end{block}
...
\centering
\includegraphics[width=0.95\linewidth]{figures/volcano_flagip.pdf}
\vskip0.3cm
\includegraphics[width=0.95\linewidth]{figures/venn_overlap.pdf}
\end{block}
...
\centering
\includegraphics[width=0.95\linewidth]{figures/go_bp_validated.pdf}
\end{block}
